...
#if WMUL ==1
#define gfmul_123 karat2_123
static inline void karat2_123(uint32_t *Out,  const uint32_t *A,  const uint32_t *B){
...
#if WMUL== 1 || WMUL == 2 || WMUL == 3
#define gfmul_124 karat2_124
static inline void karat2_124(uint32_t *Out,  const uint32_t *A,  const uint32_t *B){
...
#if WMUL== 1 || WMUL == 2
#define gfmul_125 karat2_125
static inline void karat2_125(uint32_t *Out,  const uint32_t *A,  const uint32_t *B){
...
#if WMUL== 1 || WMUL == 2 || WMUL == 3 || WMUL == 4 || WMUL == 5
#define gfmul_126 karat2_126
static inline void karat2_126(uint32_t *Out,  const uint32_t *A,  const uint32_t *B){
...
#if WMUL== 1 || WMUL == 2 || WMUL == 3 || WMUL == 4
#define gfmul_127 karat2_127
static inline void karat2_127(uint32_t *Out,  const uint32_t *A,  const uint32_t *B){
