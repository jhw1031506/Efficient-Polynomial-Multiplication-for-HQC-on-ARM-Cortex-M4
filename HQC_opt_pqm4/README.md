...
- FAFFT_baseline: HQC implementation using the Frobenius Additive FFT (FAFFT) as described in "Improved Frobenius FFT for Code-Based Cryptography on Cortex-M4" by Lee et al. (2025).
...
- hybrid_Karatsuba-FAFFT: HQC implementation utilizing a hybrid approach of the Karatsuba algorithm and FAFFT.
